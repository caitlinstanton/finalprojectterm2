...
public class Driver2 {
	...
	while (one==1) {
        if (action == "add"){
		    System.out.println("You have selected that you wish to add an object. Do you want to add a teacher, course, student, or grade? Type 'teacher', 'course', 'student', or 'grade', respectively. If you are done with your work, type 'done'." );
		    ...
		    System.out.println("You have selected that you wish to find an object. Do you want to add a teacher, course, student, or grade? Type 'teacher', 'course', or 'student', respectively. If you are done with your work, type 'done'.");
